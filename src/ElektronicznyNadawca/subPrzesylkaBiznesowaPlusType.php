...
class subPrzesylkaBiznesowaPlusType extends przesylkaType
{
     ...
     */
    public function __construct($guid, $pakietGuid, $opakowanieGuid, $opis, $planowanaDataNadania, $numerNadania, $masa, $gabaryt, $wartosc, $ostroznie, $numerPrzesylkiKlienta, $kwotaTranzakcji, $numerTransakcjiOdbioru)
    {
     ...
     * @return \App\ElektronicznyNadawca\subPrzesylkaBiznesowaPlusType
     */
