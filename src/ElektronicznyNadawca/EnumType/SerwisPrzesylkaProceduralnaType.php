...
class SerwisPrzesylkaProceduralnaType
{
     ...
     */
    const VALUE_PROCEDURALNA_STANDARD_DWA_STOPNIE = 'PROCEDURALNA_STANDARD_DWA_STOPNIE';
    /**
     * Constant for value 'PROCEDURALNA_VIP_DWA_STOPNIE'
     * @return string 'PROCEDURALNA_VIP_DWA_STOPNIE'
     */
    const VALUE_PROCEDURALNA_VIP_DWA_STOPNIE = 'PROCEDURALNA_VIP_DWA_STOPNIE';
    /**
     * Constant for value 'PROCEDURALNA_STANDARD_TRZY_STOPNIE'
     * @return string 'PROCEDURALNA_STANDARD_TRZY_STOPNIE'
     */
    const VALUE_PROCEDURALNA_STANDARD_TRZY_STOPNIE = 'PROCEDURALNA_STANDARD_TRZY_STOPNIE';
    /**
     * Constant for value 'PROCEDURALNA_VIP_TRZY_STOPNIE'
     * @return string 'PROCEDURALNA_VIP_TRZY_STOPNIE'
     */
    const VALUE_PROCEDURALNA_VIP_TRZY_STOPNIE = 'PROCEDURALNA_VIP_TRZY_STOPNIE';
    /**
