...
class TerminRodzajType
{
    ...
    /**
     * Constant for value 'BEZPOSREDNI_DO_30KG'
     * @return string 'BEZPOSREDNI_DO_30KG'
     */
    const VALUE_BEZPOSREDNI_DO_30_KG = 'BEZPOSREDNI_DO_30KG';
    /**
     ...
     * @uses self::VALUE_BEZPOSREDNI_DO_30_KG
    ...
    public static function getValidValues(): array
    {
        return [
            ...
            self::VALUE_BEZPOSREDNI_DO_30_KG,
