...
/**
 * This class stands for setEnvelopeBuforDataNadaniaResponse StructType
 * @subpackage Structs
 */
...
class SetEnvelopeBuforDataNadaniaResponse
{
    ...
    /**
     * Constructor method for setEnvelopeBuforDataNadaniaResponse
     * @uses SetEnvelopeBuforDataNadaniaResponse::setError()
     ...
     * Set error value
     * @param \App\ElektronicznyNadawca\StructType\ErrorType[] $error
     * @return \App\ElektronicznyNadawca\StructType\SetEnvelopeBuforDataNadaniaResponse
     */
