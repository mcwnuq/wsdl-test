...
/**
 * This class stands for createReturnDocumentsProfileResponse StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class CreateReturnDocumentsProfileResponse extends AbstractStructBase
{
    /**
     * The result
     * @var bool|null
    ...
    /**
     * Constructor method for createReturnDocumentsProfileResponse
     * @uses CreateReturnDocumentsProfileResponse::setResult()
     * @uses CreateReturnDocumentsProfileResponse::setIdProfile()
     * @uses CreateReturnDocumentsProfileResponse::setError()
     * @param bool $result
     * @param int $idProfile
     ...
     * Set result value
     * @param bool $result
     * @return \App\ElektronicznyNadawca\StructType\CreateReturnDocumentsProfileResponse
     */
