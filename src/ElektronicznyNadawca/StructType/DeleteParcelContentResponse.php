...
/**
 * This class stands for deleteParcelContentResponse StructType
 * @subpackage Structs
 */
...
class DeleteParcelContentResponse
{
    ...
    /**
     * Constructor method for deleteParcelContentResponse
     * @uses DeleteParcelContentResponse::setError()
     ...
     * Set error value
     * @param \App\ElektronicznyNadawca\StructType\ErrorType[] $error
     * @return \App\ElektronicznyNadawca\StructType\DeleteParcelContentResponse
     */
