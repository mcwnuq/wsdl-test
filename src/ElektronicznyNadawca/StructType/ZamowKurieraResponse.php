...
/**
 * This class stands for zamowKurieraResponse StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class ZamowKurieraResponse extends AbstractStructBase
{
    /**
     * The error
    ...
    /**
     * Constructor method for zamowKurieraResponse
     * @uses ZamowKurieraResponse::setError()
     ...
     * Set error value
     * @param \App\ElektronicznyNadawca\StructType\ErrorType[] $error
     * @return \App\ElektronicznyNadawca\StructType\ZamowKurieraResponse
     */
