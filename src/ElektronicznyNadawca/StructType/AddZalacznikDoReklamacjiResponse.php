...
/**
 * This class stands for addZalacznikDoReklamacjiResponse StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class AddZalacznikDoReklamacjiResponse extends AbstractStructBase
{
    /**
     * The error
    ...
    /**
     * Constructor method for addZalacznikDoReklamacjiResponse
     * @uses AddZalacznikDoReklamacjiResponse::setError()
     ...
     * Set error value
     * @param \App\ElektronicznyNadawca\StructType\ErrorType[] $error
     * @return \App\ElektronicznyNadawca\StructType\AddZalacznikDoReklamacjiResponse
     */
