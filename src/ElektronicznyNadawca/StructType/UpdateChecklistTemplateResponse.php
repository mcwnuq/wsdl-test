...
/**
 * This class stands for updateChecklistTemplateResponse StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class UpdateChecklistTemplateResponse extends AbstractStructBase
{
    /**
     * The error
    ...
    /**
     * Constructor method for updateChecklistTemplateResponse
     * @uses UpdateChecklistTemplateResponse::setError()
     ...
     * Set error value
     * @param \App\ElektronicznyNadawca\StructType\ErrorType[] $error
     * @return \App\ElektronicznyNadawca\StructType\UpdateChecklistTemplateResponse
     */
