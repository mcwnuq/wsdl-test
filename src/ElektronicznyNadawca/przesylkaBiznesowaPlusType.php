...
class przesylkaBiznesowaPlusType extends przesylkaRejestrowanaType
{
     ...
     */
    public function __construct($guid, $pakietGuid, $opakowanieGuid, $opis, $planowanaDataNadania, $numerNadania, $sygnatura, $terminSprawy, $rodzaj, $weryfikacjaPlatnosci, $dataDrugiejProbyDoreczenia, $drugaProbaDoreczeniaPoLiczbieDni, $posteRestante, $masa, $gabaryt, $wartosc, $kwotaTranzakcji, $ostroznie, $kategoria, $iloscPotwierdzenOdbioru, $eKontaktAdresata, $eSposobPowiadomieniaAdresata, $numerPrzesylkiKlienta, $iloscDniOczekiwaniaNaWydanie, \DateTime $oczekiwanyTerminDoreczenia, $terminRodzajPlus, $numerTransakcjiOdbioru)
    {
     ...
     * @return \App\ElektronicznyNadawca\przesylkaBiznesowaPlusType
     */
