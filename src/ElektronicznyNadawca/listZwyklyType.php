...
class listZwyklyType extends przesylkaNieRejestrowanaType
{
     ...
     */
    public function __construct($guid, $pakietGuid, $opakowanieGuid, $opis, $planowanaDataNadania, $ilosc, $posteRestante, $kategoria, $gabaryt, $masa, $egzemplarzBiblioteczny, $dlaOciemnialych, $obszarMiasto, $miejscowa)
    {
     ...
     * @return \App\ElektronicznyNadawca\listZwyklyType
     */
