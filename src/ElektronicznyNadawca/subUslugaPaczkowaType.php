...
class subUslugaPaczkowaType extends przesylkaType
{
     ...
     */
    public function __construct($guid, $pakietGuid, $opakowanieGuid, $opis, $planowanaDataNadania, $pobranie, $ubezpieczenie, $numerNadania, $masa, $wartosc, $ostroznie, $opakowanie, $ponadgabaryt, $numerPrzesylkiKlienta, $gabaryt)
    {
    ...
    /**
     * @param pobranieType $pobranie
     * @return \App\ElektronicznyNadawca\subUslugaPaczkowaType
     */
