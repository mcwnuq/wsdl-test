...
class subUslugaKurierskaType extends przesylkaType
{
     ...
     */
    public function __construct($guid, $pakietGuid, $opakowanieGuid, $opis, $planowanaDataNadania, $pobranie, $ubezpieczenie, $numerNadania, $masa, $wartosc, $ostroznie, $opakowanie, $ponadgabaryt, $numerPrzesylkiKlienta)
    {
    ...
    /**
     * @param pobranieType $pobranie
     * @return \App\ElektronicznyNadawca\subUslugaKurierskaType
     */
